...
public class MultiChannel extends MenuBasedClasses {
	...
	private void startMenu() {
		String antwort = askAndGetAnswer("Wählen Sie Ihre Oberfläche: \n [1] User-Administration \n [2] Mail-Programm");
		// Eingabe auswerten
		if (antwort.equals("1")) {
...
//			
	...
	/**
	 * Wenn sich der User für eine Mail-Session entscheidet wird hier der User ausgewählt. Dem Benutzer wird eine Liste mit bereits vorhandenen Usern zu Auswahl gestellt
	 * 
	 * @return User-Objekt
	 */
	private User userAuswahl() {
		if (getStoreuser().getUserMap().size() > 0) {
			...
			System.out.println("Es sind keine user vorhanden, erfassen Sie zuerst mindestens einen user. Zurück zum Hauptmenu..."); // Entsprechende Meldung anzeigen wenn keine bestehen User vorhanden sind
